// Generated using 'npm run generate /Users/antm88/Desktop/azure-resource-manager-schemas/schemas/2019-08-01-preview/Microsoft.Peering.json'
...
export interface DirectConnection {
  ...
  provisionedBandwidthInMbps?: Expressionable<number>;
...
export interface PeeringServicePrefixProperties {
  learnedType?: Expressionable<('None' | 'ViaPartner' | 'ViaSession')>;
  prefix?: Expressionable<string>;
  prefixValidationState?: Expressionable<('None' | 'Invalid' | 'Verified' | 'Failed' | 'Pending' | 'Unknown')>;
}
...
export interface PeeringSku {
  ...
  name?: Expressionable<('Basic_Exchange_Free' | 'Basic_Direct_Free' | 'Premium_Direct_Free' | 'Premium_Exchange_Metered' | 'Premium_Direct_Metered' | 'Premium_Direct_Unlimited')>;
