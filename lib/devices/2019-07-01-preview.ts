// Generated using 'npm run generate /Users/antm88/Desktop/azure-resource-manager-schemas/schemas/2019-07-01-preview/Microsoft.Devices.json'
...
export interface FallbackRouteProperties {
  ...
  source: Expressionable<('Invalid' | 'DeviceMessages' | 'TwinChangeEvents' | 'DeviceLifecycleEvents' | 'DeviceJobLifecycleEvents' | 'DigitalTwinChangeEvents')>;
}
