// Generated using 'npm run generate /Users/antm88/Desktop/azure-resource-manager-schemas/schemas/2018-12-01-preview/Microsoft.Devices.json'
...
export interface IotHubLocationDescription {
  ...
  role?: Expressionable<('primary' | 'secondary')>;
}
...
export interface IotHubProperties {
  ...
  locations?: Expressionable<IotHubLocationDescription[]>;
