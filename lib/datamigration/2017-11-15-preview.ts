// Generated using 'npm run generate /Users/antm88/Desktop/azure-resource-manager-schemas/schemas/2017-11-15-preview/Microsoft.DataMigration.json'
...
export namespace services {
  export namespace projects {
    export namespace tasks {
      export function create(name: [Expressionable<string>, Expressionable<string>, Expressionable<string>], properties: Unknown, location: Expressionable<string>): ResourceDefinition<Unknown> {
        return {
