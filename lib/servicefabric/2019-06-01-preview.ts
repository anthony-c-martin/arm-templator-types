// Generated using 'npm run generate /Users/antm88/Desktop/azure-resource-manager-schemas/schemas/2019-06-01-preview/Microsoft.ServiceFabric.json'
...
export interface ApplicationResourceProperties {
  managedIdentities?: Expressionable<ApplicationUserAssignedIdentity[]>;
...
export interface DiagnosticsStorageAccountConfig {
  ...
  protectedAccountKeyName2?: Expressionable<string>;
...
export namespace clusters {
  export namespace applications {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: ApplicationResourceProperties, location: Expressionable<string>): ResourceDefinition<ApplicationResourceProperties> {
      return {
