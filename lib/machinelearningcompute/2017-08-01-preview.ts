// Generated using 'npm run generate /Users/antm88/Desktop/azure-resource-manager-schemas/schemas/2017-08-01-preview/Microsoft.MachineLearningCompute.json'
...
export interface AcsClusterProperties {
  ...
  masterCount?: Expressionable<number>;
  orchestratorProperties?: Expressionable<KubernetesClusterProperties>;
  orchestratorType: Expressionable<('Kubernetes' | 'None')>;
  systemServices?: Expressionable<SystemService[]>;
}
...
export interface OperationalizationClusterProperties {
  appInsights?: Expressionable<AppInsightsProperties>;
  clusterType: Expressionable<('ACS' | 'Local')>;
...
export interface SystemService {
  systemServiceType: Expressionable<('None' | 'ScoringFrontEnd' | 'BatchFrontEnd')>;
}
