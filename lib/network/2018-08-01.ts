...
export namespace frontDoors {
  export namespace backendPools {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: BackendPoolProperties): ResourceDefinition<BackendPoolProperties> {
      return {
...
export namespace frontDoors {
  export namespace healthProbeSettings {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: HealthProbeSettingsProperties): ResourceDefinition<HealthProbeSettingsProperties> {
      return {
...
export namespace frontDoors {
  export namespace loadBalancingSettings {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: LoadBalancingSettingsProperties): ResourceDefinition<LoadBalancingSettingsProperties> {
      return {
...
export namespace frontDoors {
  export namespace routingRules {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: RoutingRuleProperties): ResourceDefinition<RoutingRuleProperties> {
      return {
...
export namespace applicationGateways {
  ...
  export function create(name: Expressionable<string>, properties: ApplicationGatewayPropertiesFormat, location: Expressionable<string>, zones?: Expressionable<string[]>): ResourceDefinition<ApplicationGatewayPropertiesFormat> & AdditionalProps {
    return {
...
export namespace virtualWans {
  export namespace p2sVpnServerConfigurations {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: P2SVpnServerConfigurationProperties): ResourceDefinition<P2SVpnServerConfigurationProperties> {
      return {
