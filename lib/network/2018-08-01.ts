...
export interface AzureManagedOverrideRuleGroup {
  ruleGroupOverride: Expressionable<('SqlInjection' | 'XSS')>;
  action: Expressionable<('Allow' | 'Block' | 'Log')>;
}

export interface AzureManagedRuleSet {
  ruleGroupOverrides?: Expressionable<AzureManagedOverrideRuleGroup[]>;
...
export interface Backend {
  ...
  enabledState?: Expressionable<('Enabled' | 'Disabled')>;
  priority?: Expressionable<number>;
  weight?: Expressionable<number>;
  backendHostHeader?: Expressionable<string>;
}

export interface BackendPool {
  id?: Expressionable<string>;
  properties?: Expressionable<BackendPoolProperties>;
  name?: Expressionable<string>;
}

export interface BackendPoolProperties {
  backends?: Expressionable<Backend[]>;
  loadBalancingSettings?: Expressionable<SubResource>;
  healthProbeSettings?: Expressionable<SubResource>;
  resourceState?: Expressionable<('Creating' | 'Enabling' | 'Enabled' | 'Disabling' | 'Disabled' | 'Deleting')>;
}

export interface CacheConfiguration {
  queryParameterStripDirective?: Expressionable<('StripNone' | 'StripAll')>;
  dynamicCompression?: Expressionable<('Enabled' | 'Disabled')>;
}

export interface CustomRule {
  name?: Expressionable<string>;
  priority: Expressionable<number>;
  ruleType: Expressionable<('MatchRule' | 'RateLimitRule')>;
  rateLimitDurationInMinutes?: Expressionable<number>;
  rateLimitThreshold?: Expressionable<number>;
  matchConditions: Expressionable<MatchCondition1[]>;
  action: Expressionable<('Allow' | 'Block' | 'Log')>;
  transforms?: Expressionable<('Lowercase' | 'Uppercase' | 'Trim' | 'UrlDecode' | 'UrlEncode' | 'RemoveNulls' | 'HtmlEntityDecode')[]>;
}

export interface CustomRules {
  rules?: Expressionable<CustomRule[]>;
}

export interface FrontDoorProperties {
  friendlyName?: Expressionable<string>;
  routingRules?: Expressionable<RoutingRule[]>;
  loadBalancingSettings?: Expressionable<LoadBalancingSettingsModel[]>;
  healthProbeSettings?: Expressionable<HealthProbeSettingsModel[]>;
  backendPools?: Expressionable<BackendPool[]>;
  frontendEndpoints?: Expressionable<FrontendEndpoint[]>;
  enabledState?: Expressionable<('Enabled' | 'Disabled')>;
  resourceState?: Expressionable<('Creating' | 'Enabling' | 'Enabled' | 'Disabling' | 'Disabled' | 'Deleting')>;
}
...
export interface FrontendEndpoint {
  id?: Expressionable<string>;
  properties?: Expressionable<FrontendEndpointProperties>;
  name?: Expressionable<string>;
}

export interface FrontendEndpointProperties {
  hostName?: Expressionable<string>;
  sessionAffinityEnabledState?: Expressionable<('Enabled' | 'Disabled')>;
  sessionAffinityTtlSeconds?: Expressionable<number>;
  webApplicationFirewallPolicyLink?: Expressionable<FrontendEndpointUpdateParametersWebApplicationFirewallPolicyLink>;
  resourceState?: Expressionable<('Creating' | 'Enabling' | 'Enabled' | 'Disabling' | 'Disabled' | 'Deleting')>;
}
...
export interface HealthProbeSettingsModel {
  id?: Expressionable<string>;
  properties?: Expressionable<HealthProbeSettingsProperties>;
  name?: Expressionable<string>;
}
...
export interface LoadBalancingSettingsModel {
  id?: Expressionable<string>;
  properties?: Expressionable<LoadBalancingSettingsProperties>;
  name?: Expressionable<string>;
}

export interface LoadBalancingSettingsProperties {
  sampleSize?: Expressionable<number>;
  successfulSamplesRequired?: Expressionable<number>;
  additionalLatencyMilliseconds?: Expressionable<number>;
  resourceState?: Expressionable<('Creating' | 'Enabling' | 'Enabled' | 'Disabling' | 'Disabled' | 'Deleting')>;
}
...
export interface ManagedRuleSets {
  ruleSets?: Expressionable<ManagedRuleSet[]>;
}

export interface MatchCondition1 {
  matchVariable: Expressionable<('RemoteAddr' | 'RequestMethod' | 'QueryString' | 'PostArgs' | 'RequestUri' | 'RequestHeader' | 'RequestBody')>;
  selector?: Expressionable<string>;
  operator: Expressionable<('Any' | 'IPMatch' | 'GeoMatch' | 'Equal' | 'Contains' | 'LessThan' | 'GreaterThan' | 'LessThanOrEqual' | 'GreaterThanOrEqual' | 'BeginsWith' | 'EndsWith')>;
  negateCondition?: Expressionable<boolean>;
  matchValue: Expressionable<string[]>;
}
...
export interface RoutingRule {
  id?: Expressionable<string>;
  properties?: Expressionable<RoutingRuleProperties>;
  name?: Expressionable<string>;
}

export interface RoutingRuleProperties {
  frontendEndpoints?: Expressionable<SubResource[]>;
  acceptedProtocols?: Expressionable<('Http' | 'Https')[]>;
  patternsToMatch?: Expressionable<string[]>;
  customForwardingPath?: Expressionable<string>;
  forwardingProtocol?: Expressionable<('HttpOnly' | 'HttpsOnly' | 'MatchRequest')>;
  cacheConfiguration?: Expressionable<CacheConfiguration>;
  backendPool?: Expressionable<SubResource>;
  enabledState?: Expressionable<('Enabled' | 'Disabled')>;
  resourceState?: Expressionable<('Creating' | 'Enabling' | 'Enabled' | 'Disabling' | 'Disabled' | 'Deleting')>;
}
...
export interface WebApplicationFirewallPolicyPropertiesFormat {
  ...
  customRules?: Expressionable<CustomRules>;
  managedRules?: Expressionable<ManagedRuleSets>;
}
...
export interface ContainerNetworkInterface {
  properties?: Expressionable<ContainerNetworkInterfacePropertiesFormat>;
  name?: Expressionable<string>;
  etag?: Expressionable<string>;
}
...
export interface ContainerNetworkInterfaceIpConfiguration {
  properties?: Expressionable<ContainerNetworkInterfaceIpConfigurationPropertiesFormat>;
  name?: Expressionable<string>;
  etag?: Expressionable<string>;
}
...
export interface ContainerNetworkInterfacePropertiesFormat {
  containerNetworkInterfaceConfiguration?: Expressionable<ContainerNetworkInterfaceConfiguration>;
  container?: Expressionable<Container>;
  ipConfigurations?: Expressionable<ContainerNetworkInterfaceIpConfiguration[]>;
}
...
export interface ExpressRouteCircuitPeeringPropertiesFormat {
  ...
  expressRouteConnection?: Expressionable<ExpressRouteConnectionId>;
...
export interface ExpressRouteCircuitSku {
  name?: Expressionable<string>;
  tier?: Expressionable<('Standard' | 'Premium' | 'Basic')>;
...
export interface ExpressRouteConnectionProperties {
  expressRouteCircuitPeering: Expressionable<ExpressRouteCircuitPeeringId>;
  authorizationKey?: Expressionable<string>;
...
export interface ExpressRouteGatewayProperties {
  ...
  virtualHub: Expressionable<VirtualHubId>;
}
...
export interface InterfaceEndpointProperties {
  fqdn?: Expressionable<string>;
  endpointService?: Expressionable<EndpointService>;
  subnet?: Expressionable<SubResource>;
}
...
export interface NetworkInterfacePropertiesFormat {
  ...
  tapConfigurations?: Expressionable<NetworkInterfaceTapConfiguration[]>;
...
export interface NetworkProfilePropertiesFormat {
  containerNetworkInterfaces?: Expressionable<ContainerNetworkInterface[]>;
...
export interface ServiceAssociationLink {
  properties?: Expressionable<ServiceAssociationLinkPropertiesFormat>;
  name?: Expressionable<string>;
}
...
export interface SubnetPropertiesFormat {
  ...
  serviceAssociationLinks?: Expressionable<ServiceAssociationLink[]>;
...
export namespace frontDoors {
  export type FrontDoorsResource = ResourceDefinition<FrontDoorProperties>;
  
  export function create(name: Expressionable<string>, properties: FrontDoorProperties, location?: Expressionable<string>): FrontDoorsResource {
    return {
...
export namespace frontDoors {
  export namespace backendPools {
    export type BackendPoolsResource = ResourceDefinition<BackendPoolProperties>;
    
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: BackendPoolProperties): BackendPoolsResource {
      return {
...
export namespace frontDoors {
  export namespace healthProbeSettings {
    export type HealthProbeSettingsResource = ResourceDefinition<HealthProbeSettingsProperties>;
    
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: HealthProbeSettingsProperties): HealthProbeSettingsResource {
      return {
...
export namespace frontDoors {
  export namespace loadBalancingSettings {
    export type LoadBalancingSettingsResource = ResourceDefinition<LoadBalancingSettingsProperties>;
    
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: LoadBalancingSettingsProperties): LoadBalancingSettingsResource {
      return {
...
export namespace frontDoors {
  export namespace routingRules {
    export type RoutingRulesResource = ResourceDefinition<RoutingRuleProperties>;
    
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: RoutingRuleProperties): RoutingRulesResource {
      return {
...
export namespace FrontDoorWebApplicationFirewallPolicies {
  export type FrontDoorWebApplicationFirewallPoliciesResource = ResourceDefinition<WebApplicationFirewallPolicyPropertiesFormat>;
  
  export function create(name: Expressionable<string>, properties: WebApplicationFirewallPolicyPropertiesFormat, location?: Expressionable<string>): FrontDoorWebApplicationFirewallPoliciesResource {
    return {
...
export namespace applicationGateways {
  ...
  export type ApplicationGatewaysResource = ResourceDefinition<ApplicationGatewayPropertiesFormat> & AddedResourceProps;
  
  export function create(name: Expressionable<string>, properties: ApplicationGatewayPropertiesFormat, location: Expressionable<string>, zones?: Expressionable<string[]>): ApplicationGatewaysResource {
    return {
...
export namespace azureFirewalls {
  export type AzureFirewallsResource = ResourceDefinition<AzureFirewallPropertiesFormat>;
  
  export function create(name: Expressionable<string>, properties: AzureFirewallPropertiesFormat, location: Expressionable<string>): AzureFirewallsResource {
    return {
...
export namespace ddosProtectionPlans {
  export type DdosProtectionPlansResource = ResourceDefinition<DdosProtectionPlanPropertiesFormat>;
...
export namespace expressRouteCircuits {
  export namespace peerings {
    export namespace connections {
      export type ConnectionsResource = ResourceDefinition<ExpressRouteCircuitConnectionPropertiesFormat>;
...
export namespace expressRouteCrossConnections {
  export type ExpressRouteCrossConnectionsResource = ResourceDefinition<ExpressRouteCrossConnectionProperties>;
...
export namespace expressRouteCrossConnections {
  export namespace peerings {
    export type PeeringsResource = ResourceDefinition<ExpressRouteCrossConnectionPeeringProperties>;
...
export namespace expressRouteGateways {
  export type ExpressRouteGatewaysResource = ResourceDefinition<ExpressRouteGatewayProperties>;
...
export namespace expressRouteGateways {
  export namespace expressRouteConnections {
    export type ExpressRouteConnectionsResource = ResourceDefinition<ExpressRouteConnectionProperties>;
...
export namespace ExpressRoutePorts {
  export type ExpressRoutePortsResource = ResourceDefinition<ExpressRoutePortPropertiesFormat>;
...
export namespace interfaceEndpoints {
  export type InterfaceEndpointsResource = ResourceDefinition<InterfaceEndpointProperties>;
  
  export function create(name: Expressionable<string>, properties: InterfaceEndpointProperties, location: Expressionable<string>): InterfaceEndpointsResource {
    return {
...
export namespace networkInterfaces {
  export namespace tapConfigurations {
    export type TapConfigurationsResource = ResourceDefinition<NetworkInterfaceTapConfigurationPropertiesFormat>;
...
export namespace networkProfiles {
  export type NetworkProfilesResource = ResourceDefinition<NetworkProfilePropertiesFormat>;
...
export namespace networkWatchers {
  export namespace connectionMonitors {
    export type ConnectionMonitorsResource = ResourceDefinition<ConnectionMonitorParameters>;
...
export namespace p2svpnGateways {
  export type P2svpnGatewaysResource = ResourceDefinition<P2SVpnGatewayProperties>;
...
export namespace publicIPPrefixes {
  ...
  export type PublicIPPrefixesResource = ResourceDefinition<PublicIPPrefixPropertiesFormat> & AddedResourceProps;
...
export namespace serviceEndpointPolicies {
  export type ServiceEndpointPoliciesResource = ResourceDefinition<ServiceEndpointPolicyPropertiesFormat>;
...
export namespace serviceEndpointPolicies {
  export namespace serviceEndpointPolicyDefinitions {
    export type ServiceEndpointPolicyDefinitionsResource = ResourceDefinition<ServiceEndpointPolicyDefinitionPropertiesFormat>;
...
export namespace virtualHubs {
  export type VirtualHubsResource = ResourceDefinition<VirtualHubProperties>;
...
export namespace virtualNetworkTaps {
  export type VirtualNetworkTapsResource = ResourceDefinition<VirtualNetworkTapPropertiesFormat>;
...
export namespace virtualWans {
  export type VirtualWansResource = ResourceDefinition<VirtualWanProperties>;
...
export namespace virtualWans {
  export namespace p2sVpnServerConfigurations {
    export type P2sVpnServerConfigurationsResource = ResourceDefinition<P2SVpnServerConfigurationProperties>;
...
export namespace vpnGateways {
  export type VpnGatewaysResource = ResourceDefinition<VpnGatewayProperties>;
...
export namespace vpnGateways {
  export namespace vpnConnections {
    export type VpnConnectionsResource = ResourceDefinition<VpnConnectionProperties>;
...
export namespace vpnSites {
  export type VpnSitesResource = ResourceDefinition<VpnSiteProperties>;
