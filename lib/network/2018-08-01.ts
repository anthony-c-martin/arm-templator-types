// Generated using 'npm run generate /Users/antm88/Desktop/azure-resource-manager-schemas/schemas/2018-08-01/Microsoft.Network.json'
...
export namespace frontDoors {
  export function create(name: Expressionable<string>, properties: FrontDoorProperties, location: Expressionable<string>): ResourceDefinition<FrontDoorProperties> {
    return {
...
export namespace frontDoors {
  export namespace backendPools {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: BackendPoolProperties, location: Expressionable<string>): ResourceDefinition<BackendPoolProperties> {
      return {
...
export namespace frontDoors {
  export namespace healthProbeSettings {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: HealthProbeSettingsProperties, location: Expressionable<string>): ResourceDefinition<HealthProbeSettingsProperties> {
      return {
...
export namespace frontDoors {
  export namespace loadBalancingSettings {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: LoadBalancingSettingsProperties, location: Expressionable<string>): ResourceDefinition<LoadBalancingSettingsProperties> {
      return {
...
export namespace frontDoors {
  export namespace routingRules {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: RoutingRuleProperties, location: Expressionable<string>): ResourceDefinition<RoutingRuleProperties> {
      return {
...
export namespace interfaceEndpoints {
  export function create(name: Expressionable<string>, properties: InterfaceEndpointProperties, location: Expressionable<string>): ResourceDefinition<InterfaceEndpointProperties> {
    return {
...
export namespace virtualWans {
  export namespace p2sVpnServerConfigurations {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: P2SVpnServerConfigurationProperties, location: Expressionable<string>): ResourceDefinition<P2SVpnServerConfigurationProperties> {
      return {
