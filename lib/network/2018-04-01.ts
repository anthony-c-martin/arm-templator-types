...
export interface DnsConfig {
  relativeName?: Expressionable<string>;
...
export interface Endpoint {
  ...
  name?: Expressionable<string>;
  type?: Expressionable<string>;
  properties?: Expressionable<EndpointProperties>;
}

export interface EndpointProperties {
  targetResourceId?: Expressionable<string>;
  target?: Expressionable<string>;
  endpointStatus?: Expressionable<('Enabled' | 'Disabled')>;
  weight?: Expressionable<number>;
  priority?: Expressionable<number>;
  endpointLocation?: Expressionable<string>;
  endpointMonitorStatus?: Expressionable<('CheckingEndpoint' | 'Online' | 'Degraded' | 'Disabled' | 'Inactive' | 'Stopped')>;
  minChildEndpoints?: Expressionable<number>;
  geoMapping?: Expressionable<string[]>;
  subnets?: Expressionable<EndpointPropertiesSubnetsItem[]>;
  customHeaders?: Expressionable<EndpointPropertiesCustomHeadersItem[]>;
}
...
export interface EndpointPropertiesSubnetsItem {
  first?: Expressionable<string>;
  last?: Expressionable<string>;
  scope?: Expressionable<number>;
}

export interface MonitorConfig {
  profileMonitorStatus?: Expressionable<('CheckingEndpoints' | 'Online' | 'Degraded' | 'Disabled' | 'Inactive')>;
  protocol?: Expressionable<('HTTP' | 'HTTPS' | 'TCP')>;
  port?: Expressionable<number>;
  path?: Expressionable<string>;
  intervalInSeconds?: Expressionable<number>;
  timeoutInSeconds?: Expressionable<number>;
  toleratedNumberOfFailures?: Expressionable<number>;
  customHeaders?: Expressionable<MonitorConfigCustomHeadersItem[]>;
  expectedStatusCodeRanges?: Expressionable<MonitorConfigExpectedStatusCodeRangesItem[]>;
}
...
export interface ProfileProperties {
  profileStatus?: Expressionable<('Enabled' | 'Disabled')>;
  trafficRoutingMethod?: Expressionable<('Performance' | 'Priority' | 'Weighted' | 'Geographic' | 'MultiValue' | 'Subnet')>;
  dnsConfig?: Expressionable<DnsConfig>;
  monitorConfig?: Expressionable<MonitorConfig>;
  endpoints?: Expressionable<Endpoint[]>;
  trafficViewEnrollmentStatus?: Expressionable<('Enabled' | 'Disabled')>;
  maxReturn?: Expressionable<number>;
}
...
export namespace trafficManagerProfiles {
  export type TrafficManagerProfilesResource = ResourceDefinition<ProfileProperties>;
  
  export function create(name: Expressionable<string>, properties: ProfileProperties, location?: Expressionable<string>): TrafficManagerProfilesResource {
    return {
