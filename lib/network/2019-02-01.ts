...
export namespace natGateways {
  ...
  export function create(name: Expressionable<string>, properties: NatGatewayPropertiesFormat, location: Expressionable<string>, sku?: Expressionable<NatGatewaySku>): ResourceDefinition<NatGatewayPropertiesFormat> & AdditionalProps {
    return {
