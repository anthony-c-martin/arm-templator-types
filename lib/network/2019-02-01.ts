...
export interface ExpressRouteCircuitConnectionPropertiesFormat {
  ...
  authorizationKey?: Expressionable<string>;
  circuitConnectionStatus?: Expressionable<('Connected' | 'Connecting' | 'Disconnected')>;
}
...
export interface ExpressRouteCircuitPropertiesFormat {
  ...
  provisioningState?: Expressionable<string>;
  gatewayManagerEtag?: Expressionable<string>;
  globalReachEnabled?: Expressionable<boolean>;
}
...
export namespace natGateways {
  ...
  export function create(name: Expressionable<string>, properties: NatGatewayPropertiesFormat, location: Expressionable<string>, sku?: Expressionable<NatGatewaySku>): NatGatewaysResource {
    return {
