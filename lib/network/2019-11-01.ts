...
export namespace networkWatchers {
  export namespace flowLogs {
    export function create(name: [Expressionable<string>, Expressionable<string>], properties: FlowLogPropertiesFormat, location: Expressionable<string>): ResourceDefinition<FlowLogPropertiesFormat> {
      return {
